...
class CarInterface(CarInterfaceBase):
  ...
  def get_params(candidate, fingerprint=gen_empty_fingerprint(), has_relay=False, car_fw=[]):
    ...
    if candidate == CAR.CIVIC:
      ...
      ret.lateralParams.torqueBP, ret.lateralParams.torqueV = [[0, 2560, 8000], [0, 2560, 3840]] # TODO: determine if there is a dead zone at the top end
      tire_stiffness_factor = 0.82
      #ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.075], [0.0225]]
      ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.95, 0.32], [0.3, 0.1]]
